...
CodechatSycClient.prototype.send_get_result = function(text) {
  var output = new this.pClass(this.output);
...
CodechatSycProcessor.prototype.process_get_result = function(seqid, input, output) {
  ...
  if (this._handler.get_result.length === 1) {
    Q.fcall(this._handler.get_result.bind(this._handler), args.text)
      .then(function(result) {
    ...
    this._handler.get_result(args.text, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
