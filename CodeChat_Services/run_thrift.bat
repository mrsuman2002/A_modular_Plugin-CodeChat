...
thrift-0.14.2.exe --gen py --strict -out ..\CodeChat_Server\CodeChat_Server\gen_py CodeChat_Services.thrift
thrift-0.14.2.exe --gen js:node,ts --strict -o ..\extensions\VSCode_Extension\src CodeChat_Services.thrift
