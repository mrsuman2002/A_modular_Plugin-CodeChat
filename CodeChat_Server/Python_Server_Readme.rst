...
=============================
In this directory, we need to install packages. To install packages run the following command from the current directory.

``pip install -U flask thrift CodeChat``
